  ...
  <body>
   <div class="line">
      ...
      <div class="welcome">
        ...
        <?php if (isset($_SESSION['Email_D'])) : ?>
            <p>
              Welcome
              <?php echo $_SESSION['Email_D']; ?>
            </p>
        </div> 
        <?php endif ?>
      <div class="img1">
      <a href ="UpcomingAppts.php"><img src="Images/refresh.png"></a>
        <p>Upcoming Appointments</p>
      </div>
     <div class="img2">
      <a href ="ApptHistory.php"><img src="Images/appointment-book.png"></a>
