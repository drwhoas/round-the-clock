...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2020 at 12:49 PM
...
ALTER TABLE `appointments`
  ...
  ADD UNIQUE KEY `UC_appointments` (`Doctor_Name`,`Date_of_Appointment`,`Time_Slot`) USING HASH;
...
--
ALTER TABLE `appointments`
  MODIFY `Sr_No` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `doctor_details`
--
ALTER TABLE `doctor_details`
  MODIFY `doctor_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `feedback`
--
ALTER TABLE `feedback`
  MODIFY `Sr_No` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
