...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2020 at 03:03 PM
...
(28, 'sakshi', 'Dr. Abhishek Rathord', 2, '2020-10-30', '17:00-18:00'),
(29, 'sakshi', 'Dr. Abhishek Rathord', 2, '2020-10-30', '17:00-18:00'),
(30, 'sakshi', 'Dr. Abhishek Rathord', 2, '2020-10-30', '17:00-18:00'),
(31, 'sakshi', 'Dr. Abhishek Rathord', 2, '2020-10-30', '17:00-18:00'),
(32, 'sakshi', 'Dr. Abhishek Rathord', 2, '2020-10-30', '17:00-18:00');
...
(22, 'ananya', 30, 8879715227, 'anan@gmail.com', 'ANAN', 'ANAN'),
(26, 'Sakshi Singhvi', 25, 9619284577, 'sakshisinghvi2000@gmail.com', 'hihihi', 'hihihi');
...
(14, 'Sakshi Singhvi', 'sakshisinghvi2000@gmail.com', '', 'hiheifhwoujh'),
(15, 'Sakshi Singhvi', 'sakshisinghvi2000@gmail.com', '', 'hiheifhwoujh');
...
INSERT INTO `login` (`Name`, `Age`, `Phone`, `Email`, `Password`, `Confirm_Password`) VALUES
('Dr. Abhishek Rathord', 35, 884756384, 'abhishek.rathord@roundtheclock.com', 'Password@123', 'Password@123'),
('Dr. Aditi Singh', 32, 873543976, 'aditi.singh@roundtheclock.com', 'Password@123', 'Password@123'),
('Ankita Tata', 40, 998472648, 'ankitatata83@gmail.com', 'Password@123', 'Password@123'),
('Dhiraj Shetty', 39, 994858394, 'dhiraj99@gmail.com', 'Password@123', 'Password@123'),
('Umesh Goyal', 29, 993847293, 'goyal.umesh@yahoo.co.in', 'Password@123', 'Password@123'),
('Anil Joshi', 50, 848593829, 'joshi.anil2@gmail.com', 'Password@123', 'Password@123'),
('Maya Saxena', 12, 848593853, 'mayasaxena26@yahoo.in', 'Password@123', 'Password@123'),
('Dr. Nikita Sonavane', 49, 998345639, 'nikita.sonavne2@roundtheclock.com', 'Password@123', 'Password@123'),
('Roxanne D\'Souza', 20, 948594845, 'roxanne.admin@roundtheclock.com', 'Password@123', 'Password@123'),
('Tanvi', 16, 9757085051, 'sakshisinghvi2000@gmail.com', 'sakshi', 'sakshi'),
('Urvashi Gopal', 16, 948593847, 'urvashigopal3@gmail.com', 'Password@123', 'Password@123');
...
--
ALTER TABLE `appointments`
  MODIFY `Sr_No` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `doctor_details`
--
ALTER TABLE `doctor_details`
  MODIFY `doctor_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `feedback`
--
ALTER TABLE `feedback`
  MODIFY `Sr_No` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `medical_history`
--
ALTER TABLE `medical_history`
  MODIFY `Patient_Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
